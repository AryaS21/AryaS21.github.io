        ...
        <div class="row">
                ...
                <div class="box">
                    ...
                    <form action="pages/function/Profile.php?aksi=edit" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label>NISN <small style="color: red;">* Wajib diisi</small></label>
                            ...
                            <div class="form-group">
                                <label>Asal Sekolah <small style="color: red;">* Wajib diisi</small></label>
                                <textarea class="form-control" style="height: 30px; resize: none;" name="Alamat" required><?= $row['alamat']; ?></textarea>
                            </div>
                        </div>
                        <!-- /.box-body -->
            ...
            <div class="col-md-4">
                <div class="box">
                    ...
                    <div class="box-body">
                        <!-- Animasi -->
                        <img src="../../assets/dist/img/4.jpg" style="width: 125px; height: 125px; display: block; margin-left: auto; margin-right: auto; margin-top: -5px; margin-bottom: 15px;" loop autoplay></lottie-player>
                        <!-- -->
                        <p style="font-weight: bold;">Kode Anggota : <?= $row['kode_user']; ?></p>
                        <p style="font-weight: bold;">NISN : <?= $row['nis']; ?></p>
