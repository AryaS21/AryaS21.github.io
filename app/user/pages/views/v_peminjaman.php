                            ...
                            <section id="new">
                                ...
                                <form action="pages/function/Peminjaman.php?aksi=pinjam" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="judulBuku" list="datalistOptions" id="exampleDataList" placeholder="Type to search...">
                                        <datalist id="datalistOptions">
                                            <option value="San Francisco">
                                            <option value="New York">
                                            <option value="Seattle">
                                            <option value="Los Angeles">
                                            <option value="Da Peci Code">
                                            <option value="Rosid & Delia">
                                            <option value="Beauty Is A Wound">
                                            <option value="The 5 Levels of Leadership">
                                            <option value="Murder On The Orient Express">
                                            <option value="How to Talk to Anyone">  
                                            <option value="I Want to Die But I Want to Eat Tteokbokki"> 
                                            <option value="Cursed Bunny"> 
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="tanggalPengembalian" value=" <?php
                                        $tgl_peminjaman = date('d-M-Y');
                                        $tglpengembalian = date('d-M-Y', strtotime('+14 days', strtotime($tgl_peminjaman)));
                                        echo "$tglpengembalian";                                                                                         
                                    ?>"
                                    readonly>
